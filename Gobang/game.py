...
class five_chess() :
    ...
    def run(self) :
        ...
        # 加载图片
        icon = pygame.image.load('F:\python\gobang\in.ico')
        
        boardImage = pygame.image.load('F:\\python\\gobang\\board.jpg')
        boardRect = boardImage.get_rect()
        blackImage = pygame.image.load('F:\\python\\gobang\\black.jpg')
        blackRect = blackImage.get_rect()
        whiteImage = pygame.image.load('F:\\python\\gobang\\white.jpg')
        whiteRect = whiteImage.get_rect()
        restartImage_up = pygame.image.load('F:\\python\\gobang\\restart_up.png')
        rsupRect = restartImage_up.get_rect()
        restartImage_down = pygame.image.load('F:\\python\\gobang\\restart_down.png')
