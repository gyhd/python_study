...
python demo_yolo3_deepsort.py VIDEO_PATH=./mv --yolo_cfg=./YOLOv3/cfg/yolo_v3.cfg --yolo_weights=./YOLOv3/yolov3.weights --yolo_names=./YOLOv3/cfg/coco.names --conf_thresh=0.5 --nms_thresh=0.4 --deepsort_checkpoint=./deep_sort/deep/checkpoint/ckpt.t7 --max_dist=0.2 --display_width=800 --display_height=600 --save_path=./demo.avi --use_cuda=True
