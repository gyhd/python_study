# -*- coding: utf-8 -*-
"""
Created on Tue Aug  6 22:42:55 2019
...
parameters = two_layer_model(train_x, train_set_y, layers_dims = (n_x, n_h, n_y), num_iterations = 200, print_cost=True,isPlot=True)
...
#把一张图片放在一个特定位置，然后识别它
my_image = r"C:\Users\Maibenben\Desktop\cat.jpg" # change this to the name of your image file 
