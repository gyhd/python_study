# -*- coding: utf-8 -*-
"""
Created on Wed May  8 11:37:12 2019
...
class Camera_reader(object):
    ...
    def build_camera(self):
        ...
        face_cascade = cv2.CascadeClassifier(r'F:\\Anaconda3\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_alt.xml')
        #读取dataset数据集下的子文件夹名称
        name_list = read_name_list(r'F:\\FR_data')
        #打开摄像头并开始读取画面
        ...
        while success and cv2.waitKey(1) == -1:
             ...
             for (x, y, w, h) in faces:
                 ...
                 if prob > 0.5:    #如果模型认为概率高于50%则显示为模型中已有的label
