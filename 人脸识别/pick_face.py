# -*- coding: utf-8 -*-
"""
Created on Wed May  8 11:31:21 2019
...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier(r'E:\\anaconda\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_alt.xml')
...
if __name__ == '__main__':
     readPicSaveFace('E:\\project\\source_gww','E:\\project\\pictest','.jpg','.JPG','png','PNG')
